...
- [软件学院MSE网上选课系统介绍](#软件学院mse网上选课系统介绍)
- [一、MSE网上选课系统的用例图](#一mse网上选课系统的用例图)
- [二、MSE网上选课系统的部分活动图](#二mse网上选课系统的部分活动图)
- [三、MSE网上选课系统的部分顺序图](#三mse网上选课系统的部分顺序图)
- [四、MSE网上选课系统的部分协作图](#四mse网上选课系统的部分协作图)
- [五、MSE网上选课系统的类图](#五mse网上选课系统的类图)
- [六、MSE网上选课系统的部分状态图](#六mse网上选课系统的部分状态图)
- [七、MSE网上选课系统的组件图](#七mse网上选课系统的组件图)
- [八、MSE网上选课系统的部署图](#八mse网上选课系统的部署图)
